...
function Hero() { return <section className="hero hero-poster" id="inicio"><div className="hero-copy"><h1><span>profissionalize</span> <span>a comunicação</span> <span>da sua banda.</span></h1><div className="hero-meta"><p>músicos não precisam virar criadores de conteúdo. quem entende da cena cuida da comunicação para vocês tocarem.</p><p>curitiba / brasil<br />comunicação para bandas independentes</p></div><WhatsAppLink>falar sobre a sua banda</WhatsAppLink></div><figure className="hero-visual hero-collage"><div className="hero-paper" aria-hidden="true" /><img src={image('show-01.webp')} alt="público e banda durante show fotografado por isabella monteiro" fetchPriority="high" /><img src={image('show-03.webp')} alt="banda tocando em um show fotografado por isabella monteiro" loading="eager" /><img src={image('show-06.webp')} alt="apresentação ao vivo fotografada por isabella monteiro" loading="eager" /></figure></section> }
