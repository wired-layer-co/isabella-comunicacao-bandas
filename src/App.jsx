...
const services = [
  ...
  { id: 'video', title: 'captação e edição de vídeo', description: 'reels/tiktoks para lançamentos, divulgação de shows, clipes e material para redes sociais.', note: 'conteúdo para divulgar o que a banda está fazendo.', link: briefingUrl, media: ['video-cover-1.webp', 'video-cover-2.webp', 'video-cover-3.webp'] },
  ...
  { id: 'design', title: 'design e artes visuais', description: 'capas de single/álbum, identidade visual, animações mixed media, zines, cartazes de turnê e artes para feed.', note: 'visuais para single, show e redes sociais.', link: briefingUrl, media: ['design-hayley.webp', 'design-ego-1.webp', 'design-ode.webp'] },
]
